...
1. [Что такое miu](#Что такое miu)
1. [Быстрый старт](#Быстрый старт)
1. [ну а это просто комментарий, так как перед ним ничего нет!](#ну а это просто комментарий, так как перед ним ничего нет!)
1. [Тестируем javascript](#Тестируем javascript)
1. [Программный код](#Программный код)
1. [Как выполнить тесты из раздела статьи](#Как выполнить тесты из раздела статьи)
1. [Маски файлов и разделов](#Маски файлов и разделов)
1. [Инициализатор](#Инициализатор)
1. [инициализация тестов](#инициализация тестов)
1. [Конфигурационный файл](#Конфигурационный файл)
1. [конфигурационный файл miu](#конфигурационный файл miu)
1. [директории указываются от](#директории указываются от)
1. [директория с файлами miu](#директория с файлами miu)
1. [default: miu](#default: miu)
1. [главная директория для создаваемых файлов](#главная директория для создаваемых файлов)
1. [default: .miu](#default: .miu)
1. [директория куда будут выложены статьи в формате markdown](#директория куда будут выложены статьи в формате markdown)
1. [default: $out_dir/mark](#default: $out_dir/mark)
1. [директория куда будут выложены файлы `@@ ...`](#директория куда будут выложены файлы `@@ ...`)
1. [default: $out_dir/lib](#default: $out_dir/lib)
1. [директория для выкладывания тестов](#директория для выкладывания тестов)
1. [default: $out_dir/t](#default: $out_dir/t)
1. [директория которая будет текущей при выполнении тестов](#директория которая будет текущей при выполнении тестов)
1. [default: $t_dir](#default: $t_dir)
1. [директория для логов](#директория для логов)
1. [default: $out_dir/log](#default: $out_dir/log)
1. [задаёт из какого файла miu сделать README.md](#задаёт из какого файла miu сделать README.md)
1. [если не указан - не создаётся](#если не указан - не создаётся)
1. [репортёр. Список репортёров см. в lib/Miu/Reporter](#репортёр. Список репортёров см. в lib/Miu/Reporter)
1. [путь к браузеру для [jsb]-тестов](#путь к браузеру для [jsb]-тестов)
1. [Какие файлы создаёт miu](#Какие файлы создаёт miu)
1. [Установка](#Установка)
1. [Как конвертировать markdown в html](#Как конвертировать markdown в html)
1. [Как конвертировать markdown в bbcode](#Как конвертировать markdown в bbcode)
1. [Откуда название **miu**?](#Откуда название **miu**?)
1. [TODO или куда miu будет развиваться](#TODO или куда miu будет развиваться)
